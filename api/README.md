...
## Overrides in the [package.json](./package.json)

In this section, we include packages with vulnerabilities and fix them by overriding their child dependencies. This helps us keep track of which packages had vulnerabilities, making it easier to check if the authors fixed them later.

1. "glob": "npm:fast-glob@3.3.2" - we need to override this because of a security vulnerability in the pm2 package.
2. "braces": "3.0.3" - we need to override this because of a security vulnerability in the pm2 package. (Introduced through: api-boilerplate@1.0.0 › pm2@5.4.0 › chokidar@3.6.0 › braces@3.0.2)
3. "ws": "8.18.0" - we need to override this because of a security vulnerability in the pm2 package. (Introduced through: api-boilerplate@1.0.0 › pm2@5.4.0 › @pm2/agent@2.0.3 › ws@7.4.6)
